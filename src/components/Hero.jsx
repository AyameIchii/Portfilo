...
import {Github, Facebook, X, Mail, ArrowDown } from "lucide-react";
...
return ( 
         ...
         <div className={`transition-all duration-1000 ${hasAnimated.hero ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} id="hero">
            ...
            <div className="h-12 md:h-16 mb-6  flex items-center justify-center">
                <h2 className="text-2xl md:text-4xl font-semibold text-gray-700">
                    I'm a {' '}
                    <span className="text-blue-600 font-bold"> {currentText}
            ...
            <div className="flex justify-center space-x-6 mb-8 animate-fade-in-up delay-400">
                    {heroData.socialLinks.map((social, index) => {
                        const IconComponent = social.icon === 'Github' ? Github : social.icon === 'Facebook' ? Facebook : social.icon === 'X' ? X : Mail;
                        return (
    ...
    <div className="absolute bottom-20 right-10 w-5 h-5 bg-orange-400 rounded-ful opacity-60 animate-float delay-3000 "></div>
